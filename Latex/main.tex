...
\documentclass[oneside,printmode,eng]{mgr}  % do wydruku dwustronnego
...
\include{praca_dyplomowa/sources/00_Wstep}
\include{praca_dyplomowa/sources/01_wprowadzenie_matematyczne}
\include{praca_dyplomowa/sources/02_symulacja}
\include{praca_dyplomowa/sources/03_konstrukcja}
\include{praca_dyplomowa/sources/04_elektronika}
\include{praca_dyplomowa/sources/05_oprogramowanie}
\include{praca_dyplomowa/sources/06_sterowanie}
\include{praca_dyplomowa/sources/50_zakonczenie}
